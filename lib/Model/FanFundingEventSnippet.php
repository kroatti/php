...
/**
 * FanFundingEventSnippet Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FanFundingEventSnippet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FanFundingEventSnippet';
     ...
     * Sets amount_micros
     *
     * @param string $amount_micros The amount of funding in micros of fund_currency. e.g., 1 is represented
     *
     * @return $this
     */
     ...
     * Sets channel_id
     *
     * @param string $channel_id Channel id where the funding event occurred.
     *
     * @return $this
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time when the funding occurred. The value is specified in ISO 8601 (YYYY-MM-DDThh:mm:ss.sZ) format.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency The currency in which the fund was made. ISO 4217.
     *
     * @return $this
     */
     ...
     * Sets display_string
     *
     * @param string $display_string A rendered string that displays the fund amount and currency (e.g., \"$1.00\"). The string is rendered for the given language.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ChannelProfileDetails $supporter_details Details about the supporter. Only filled if the event was made public by the user.
     *
     * @return $this
     */
