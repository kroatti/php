...
class AccessPolicy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccessPolicy';
     ...
     * Sets allowed
     *
     * @param bool $allowed The value of allowed indicates whether the access to the policy is allowed or denied by default.
     *
     * @return $this
     */
     ...
     * Sets exception
     *
     * @param string[] $exception A list of region codes that identify countries where the default policy do not apply.
     *
     * @return $this
     */
