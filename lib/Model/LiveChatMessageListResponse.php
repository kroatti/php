...
/**
 * LiveChatMessageListResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LiveChatMessageListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LiveChatMessageListResponse';
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\LiveChatMessage[]',
        'kind' => 'string',
    ...
    protected static $swaggerFormats = [
        ...
        'offline_at' => 'date-time',
        'page_info' => null,
        'polling_interval_millis' => 'uint32',
    ...
    protected static $setters = [
        ...
        'polling_interval_millis' => 'setPollingIntervalMillis',
    ...
    protected static $getters = [
        ...
        'polling_interval_millis' => 'getPollingIntervalMillis',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#liveChatMessageListResponse';
        $this->container['next_page_token'] = isset($data['next_page_token']) ? $data['next_page_token'] : null;
        $this->container['offline_at'] = isset($data['offline_at']) ? $data['offline_at'] : null;
        $this->container['page_info'] = isset($data['page_info']) ? $data['page_info'] : null;
        $this->container['polling_interval_millis'] = isset($data['polling_interval_millis']) ? $data['polling_interval_millis'] : null;
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\LiveChatMessage[] $items A list of live chat messages.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#liveChatMessageListResponse\".
     *
     * @return $this
     */
     ...
     * Sets offline_at
     *
     * @param \DateTime $offline_at The date and time when the underlying stream went offline. The value is specified in ISO 8601 (YYYY-MM-DDThh:mm:ss.sZ) format.
     *
     * @return $this
     */
    ...
    /**
     * Gets polling_interval_millis
     *
     * @return int
     */
    public function getPollingIntervalMillis()
    {
        return $this->container['polling_interval_millis'];
    }

    /**
     * Sets polling_interval_millis
     *
     * @param int $polling_interval_millis The amount of time the client should wait before polling again.
     *
     * @return $this
     */
    public function setPollingIntervalMillis($polling_interval_millis)
    {
        $this->container['polling_interval_millis'] = $polling_interval_millis;
