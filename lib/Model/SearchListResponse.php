...
/**
 * SearchListResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SearchListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SearchListResponse';
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\SearchResult[]',
        'kind' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#searchListResponse';
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\SearchResult[] $items A list of results that match the search criteria.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#searchListResponse\".
     *
     * @return $this
     */
