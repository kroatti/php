...
/**
 * PlaylistListResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PlaylistListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PlaylistListResponse';
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\Playlist[]',
        'kind' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#playlistListResponse';
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\Playlist[] $items A list of playlists that match the request criteria.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#playlistListResponse\".
     *
     * @return $this
     */
