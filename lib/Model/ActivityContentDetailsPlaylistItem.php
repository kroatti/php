...
/**
 * ActivityContentDetailsPlaylistItem Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActivityContentDetailsPlaylistItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ActivityContentDetailsPlaylistItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['playlist_item_id'] = isset($data['playlist_item_id']) ? $data['playlist_item_id'] : null;
     ...
     * Sets playlist_id
     *
     * @param string $playlist_id The value that YouTube uses to uniquely identify the playlist.
     *
     * @return $this
     */
     ...
     *
     * @param string $playlist_item_id ID of the item within the playlist.
     *
     * @return $this
     */
     ...
     * Sets resource_id
     *
     * @param \Swagger\Client\Model\ResourceId $resource_id The resourceId object contains information about the resource that was added to the playlist.
     *
     * @return $this
     */
