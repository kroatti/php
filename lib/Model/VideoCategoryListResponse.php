...
/**
 * VideoCategoryListResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VideoCategoryListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoCategoryListResponse';
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\VideoCategory[]',
        'kind' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#videoCategoryListResponse';
        ...
        $this->container['prev_page_token'] = isset($data['prev_page_token']) ? $data['prev_page_token'] : null;
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\VideoCategory[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\VideoCategory[] $items A list of video categories that can be associated with YouTube videos. In this map, the video category ID is the map key, and its value is the corresponding videoCategory resource.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#videoCategoryListResponse\".
     *
     * @return $this
     */
     ...
     *
     * @param string $prev_page_token The token that can be used as the value of the pageToken parameter to retrieve the previous page in the result set.
     *
     * @return $this
     */
