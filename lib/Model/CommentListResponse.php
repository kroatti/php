...
class CommentListResponse implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#commentListResponse';
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\Comment[] $items A list of comments that match the request criteria.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#commentListResponse\".
     *
     * @return $this
     */
