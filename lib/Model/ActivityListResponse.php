 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActivityListResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\Activity[]',
        'kind' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#activityListResponse';
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\Activity[] $items A list of activities, or events, that match the request criteria.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#activityListResponse\".
     *
     * @return $this
     */
