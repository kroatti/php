...
class VideoListResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\Video[]',
        'kind' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#videoListResponse';
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\Video[] $items A list of videos that match the request criteria.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#videoListResponse\".
     *
     * @return $this
     */
