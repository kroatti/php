...
/**
 * VideoFileDetailsAudioStream Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VideoFileDetailsAudioStream implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VideoFileDetailsAudioStream';
     ...
     * Sets bitrate_bps
     *
     * @param string $bitrate_bps The audio stream's bitrate, in bits per second.
     *
     * @return $this
     */
     ...
     * Sets channel_count
     *
     * @param int $channel_count The number of audio channels that the stream contains.
     *
     * @return $this
     */
     ...
     * Sets codec
     *
     * @param string $codec The audio codec that the stream uses.
     *
     * @return $this
     */
