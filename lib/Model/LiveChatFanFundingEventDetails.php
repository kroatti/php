...
/**
 * LiveChatFanFundingEventDetails Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LiveChatFanFundingEventDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LiveChatFanFundingEventDetails';
     ...
     * Sets amount_micros
     *
     * @param string $amount_micros The amount of the fund.
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string $currency The currency in which the fund was made.
     *
     * @return $this
     */
     ...
     * Sets user_comment
     *
     * @param string $user_comment The comment added by the user to this fan funding event.
     *
     * @return $this
     */
