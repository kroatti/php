 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LiveStreamListResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LiveStreamListResponse';
    ...
    protected static $swaggerTypes = [
        'etag' => 'string',
        'event_id' => 'string',
        'items' => '\Swagger\Client\Model\LiveStream[]',
        'kind' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kind'] = isset($data['kind']) ? $data['kind'] : 'youtube#liveStreamListResponse';
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\LiveStream[] $items A list of live streams that match the request criteria.
     *
     * @return $this
     */
     ...
     * Sets kind
     *
     * @param string $kind Identifies what kind of resource this is. Value: the fixed string \"youtube#liveStreamListResponse\".
     *
     * @return $this
     */
