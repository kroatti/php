...
**items** | [**\Swagger\Client\Model\Sponsor[]**](Sponsor.md) | A list of sponsors that match the request criteria. | [optional] 
**kind** | **string** | Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#sponsorListResponse\&quot;. | [optional] [default to 'youtube#sponsorListResponse']
