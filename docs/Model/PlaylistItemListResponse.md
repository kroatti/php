...
**items** | [**\Swagger\Client\Model\PlaylistItem[]**](PlaylistItem.md) | A list of playlist items that match the request criteria. | [optional] 
**kind** | **string** | Identifies what kind of resource this is. Value: the fixed string \&quot;youtube#playlistItemListResponse\&quot;. | [optional] [default to 'youtube#playlistItemListResponse']
